...
var select = document.querySelector("#mainButton")
...
function sendApiRequest(x) {
    fetch("https://api.giphy.com/v1/gifs/search?api_key=9Gj4ujb7a9MI6lKF8gvY2Un1gBdgFSMp&q="+x+"&limit=25&offset=0&rating=G&lang=en")
    .then(function(data) {
      return data.json();
    })
    .then(function(json) {
...
function addImageToScreen(myURL) {
  ...
  //Where the single quotes are located concatenate your myURL parameter to the img tag element.
